            ...
            <Grid item xs={12} md={9} lg={9} xl={10}>
                ...
                <Grid item xs={12} className={classes.wrapper_component}>
                    ...
                    <div className="add_list">
                        <Link className="item_add_list active" to={"/reports/marketing/patient"}>Счета и оплата</Link>
                        <Link className="item_add_list" to={"/reports/marketing/discounts"}>Оказание услуги</Link>
                        <Link className="item_add_list" to={"/reports/marketing/adminConversion"}>Движение денежных средств</Link>
                        <Link className="item_add_list" to={"/reports/marketing/advertisingChannels"}>Выручка по направлениям</Link>
                    </div>
                    <Grid item className={`contaoner-info container_materials`}>
                        ...
                        {!hideBtnClicked.block_1? (
                            <>
                                <div className="title_material_table">Отчет. Счета и оплата.</div>
