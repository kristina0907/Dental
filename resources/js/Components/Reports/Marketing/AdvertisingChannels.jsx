            ...
            <Grid item xs={12} md={9} lg={9} xl={10}>
                ...
                <Grid item xs={12} className={classes.wrapper_component}>
                    ...
                    <div className="add_list">
                        ...
                        <Link className="item_add_list active" to={"/reports/marketing/advertisingChannels"}>Рекламные каналы и источники</Link>
                    </div>
                    <Grid item className={`contaoner-info container_materials`}>
                        ...
                        {!hideBtnClicked.block_1? (
                            <>
                                <div className="title_material_table">Отчет. Рекламные каналы и источники</div>
